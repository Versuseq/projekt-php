 ...
 */
final class Version20250507190651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dishes_section (dishes_id INT NOT NULL, section_id INT NOT NULL, INDEX IDX_B696F9E5A05DD37A (dishes_id), INDEX IDX_B696F9E5D823E37A (section_id), PRIMARY KEY(dishes_id, section_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE dishes DROP section');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dishes ADD section VARCHAR(255) DEFAULT NULL');
    }
}
